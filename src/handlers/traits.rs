...
pub trait InputHandler {
    fn input(&mut self, fd: i32, cond: crate::PurpleInputCondition);
    fn enable_input(&mut self, fd: i32, cond: crate::PurpleInputCondition) -> u32
    where
        Self: 'static,
    {
        let self_ptr: *mut Self = self;
        crate::input_add(fd, cond, move |fd, cond| {
...
pub trait CommandHandler {
    ...
    {
        let self_ptr: *mut Self = self;
        crate::register_cmd(cmd, args, help_text, move |conversation, cmd, args| {
            let this = unsafe { &mut *self_ptr };
